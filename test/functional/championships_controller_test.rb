...
class ChampionshipsControllerTest < ActionController::TestCase
  ...
  test "should create championship" do
    assert_difference('Championship.count') do
      post :create, championship: { classification: @championship.classification, groups: @championship.groups, name: @championship.name, rule_id: @championship.rule_id }
    end
  ...
  test "should update championship" do
    put :update, id: @championship, championship: { classification: @championship.classification, groups: @championship.groups, name: @championship.name, rule_id: @championship.rule_id }
    assert_redirected_to championship_path(assigns(:championship))
  end
